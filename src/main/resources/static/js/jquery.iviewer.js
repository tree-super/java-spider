...
$.widget( "ui.iviewer", $.ui.mouse, {
    ...
    _create: function() {
        ...
        */
        ...
        this.controls = this.container.find('.viewer-btn') || {};
        this._mouseInit();
    },
    ...
    **/
    createui: function()
    {
        ...
        $("<div>", {'title':'放大','class': "iviewer_zoom_in iviewer_button"})
                    .bind('mousedown touchstart',function(){me.zoom_by(1); return false;})
                    .appendTo(this.container.children(".viewer-btn"));

        $("<div>", {'title':'缩小','class': "iviewer_zoom_out iviewer_button"})
                    .bind('mousedown touchstart',function(){me.zoom_by(- 1); return false;})
                    .appendTo(this.container.children(".viewer-btn"));

        $("<div>", {'title':'原始尺寸','class': "iviewer_zoom_zero iviewer_button"})
                    .bind('mousedown touchstart',function(){me.set_zoom(100); return false;})
                    .appendTo(this.container.children(".viewer-btn"));

        $("<div>", {'title':'自适应大小','class': "iviewer_zoom_fit iviewer_button"})
        ...
        $("<div>", {'title':'逆时针旋转90度','class': "iviewer_rotate_left iviewer_button"})
                    .bind('mousedown touchstart',function(){me.angle(-90); return false;})
                    .appendTo(this.container.children(".viewer-btn"));

        $("<div>", {'title':'顺时针旋转90度','class': "iviewer_rotate_right iviewer_button" })
                    .bind('mousedown touchstart',function(){me.angle(90); return false;})
                    .appendTo(this.container.children(".viewer-btn"));
